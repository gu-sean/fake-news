...
# 스크립트 위치를 기준으로 모든 입력/출력 경로를 잡습니다.
# 그래서 어느 폴더에서 실행해도 같은 파일을 읽고 씁니다.
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
VECTOR_DIR = os.path.join(SCRIPT_DIR, "vector")

# 모델 학습 전에 미리 만들어 둔 벡터 데이터 파일입니다.
...
LOG_PATH = os.path.join(SCRIPT_DIR, "xgboost_V1_log.txt")
BEST_MODEL_PATH = os.path.join(SCRIPT_DIR, "best_model_xgboost_V1.pkl")
BEST_CONFIG_PATH = os.path.join(SCRIPT_DIR, "best_config_xgboost_V1.txt")
