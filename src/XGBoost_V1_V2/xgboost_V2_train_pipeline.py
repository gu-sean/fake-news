...
# 그래서 터미널의 현재 위치와 상관없이 같은 파일을 읽고 씁니다.
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
VECTOR_DIR = os.path.join(SCRIPT_DIR, "vector")

# XGBoost가 바로 사용할 사전 벡터화 데이터 파일입니다.
...
# V2는 학습된 모델 하나와 최종 성능 리포트 하나를 저장합니다.
MODEL_PATH = os.path.join(SCRIPT_DIR, "best_model_xgboost_V2.pkl")
METRICS_PATH = os.path.join(SCRIPT_DIR, "performance_xgboost_V2.txt")
