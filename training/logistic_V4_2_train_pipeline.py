...
_LR_OUT_DIR     = os.path.join(PROJECT_DIR, "models", "logistic")
LOG_PATH         = os.path.join(_LR_OUT_DIR, "logistic_V4_2_log.txt")
BEST_MODEL_PATH  = os.path.join(_LR_OUT_DIR, "best_model_V4_2.pkl")
BEST_CONFIG_PATH = os.path.join(_LR_OUT_DIR, "best_config_V4_2.txt")
